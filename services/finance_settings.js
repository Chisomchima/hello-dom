export default axios => ({
    ...
    getPayerSchemesbyCategory(params) {
        return axios.$get(`finance/payer_schemes/categories/`, { params });
    },
    viewPayer(id) {
    ...
    editPricelistItem(body, id) {
        return axios.$patch(`finance/price_list_items/${id}/`, body)
    },
