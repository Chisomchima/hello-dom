  ...
  <div class="conatiner">
      ...
      >
        ...
        <div>
          <div class="dropdown">
            ...
            >
              <a class="dropdown-item" href="#" @click="Post()"
                >Request Approval</a
              >
    ...
    <div class="card bg-white mb-3">
      <div class="card-header pt-4 pb-0">
        <div class="card-title text-light fs-24">Create Lesson Plan</div>
        <hr class="mb-0" />
      </div>
      <div class="card-body">
        <div>
          <ValidationObserver v-slot="{ handleSubmit }">
            <form class="row" @submit.prevent="handleSubmit(submitForm)">
              <div class="col-md-6 my-2">
                ...
                >
                  <v-select
                    v-model="selectedData.grade_level"
                    class="style-chooser"
              ...
              <div class="col-md-6 my-2">
                ...
                >
                  <v-select
                    v-model="selectedData.academic_year"
                    class="style-chooser"
              ...
              <div class="col-md-6 my-2">
                ...
                >
                  <v-select
                    v-model="selectedData.academic_period"
                    class="style-chooser"
              ...
              <div class="col-md-6 my-2">
                ...
                >
                  <v-select
                    v-model="selectedData.academic_week"
                    class="style-chooser"
          ...
          >
              ...
              <div class="card card-bordered bg-grayish-variant-2">
                ...
                <div class="card-body border-bottom py-3">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1">
                      ...
                      >
                        <BaseInput
                          v-model="selectedContent[i].subtopic"
                ...
                <div class="card-body py-3">
                  ...
                  >
                    ...
                    <div>
                      <button
                        class="btn btn-light text-primary bg-white py-2"
            ...
            <div v-else>
              <!-- <lesson-plan-content></lesson-plan-content> -->
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            <span @click="deletefile(i, fileindex)">
                              <Icon
...
export default {
  ...
  async fetch() {
    ...
    const topic = await this.$axios.$get(
      `/schools/v3/${this.$store.state.administration.school.id}/lessonplan/list/?page=1&page_size=20&filter_category=all`
    )

    topic.data.results.forEach((el) =>
      el.content.sections.forEach((element) => {
        if (element.type === 'topics_subtopics') {
          this.existingTopics.push(element)
        }
      })
    )

    console.log(this.existingTopics)
  },
  ...
  methods: {
    ...
    async handlefileupload(event, i) {
      if (event.target.files[0]) {
        ...
        // temp2.forEach((e) => {
        //   console.log(e);
        //   this.selectedContent[i].files.push({
        //     name: e.name,
        //     size: e.size,
        //     type: e.type,
        //   });
        ...
        console.log('IMPORTANT', this.selectedContent[i].files)
      }
    },
    ...
    deletefile(i, fileindex) {
      this.selectedContent[i].files.splice(fileindex, 1)
    },
    ...
    async Post() {
      ...
      const lessonplan = {
        ...
        grade_level: this.selectedData.grade_level,
        academic_year: this.selectedData.academic_year,
        academic_period: this.selectedData.academic_period,
        academic_week: this.selectedData.academic_week,
      ...
      try {
        ...
        await this.$axios.$post(
          `schools/v3/${schoolId}/lessonplan/create/`,
          lessonplan
        )
