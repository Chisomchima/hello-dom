<template>
    <div>
        ...
        <div class="modal">
            <b-modal id="Add-encounter" title="Add Encounter" centered hide-footer ref="encounterModal"
                @hide="closeModal()">
...
" v-model="test" v-debounce:1300ms.cancelonempty="searchPatient" />
                                ...
                                <div class="mb-2 col-lg-6 pr-2 pl-0 col-md-6 col-sm-6">
                                    ...
                                    <input type="text" disabled v-model="patientData.phone_number"
                                        placeholder="Phone No." class="form-control " />
                                </div>

                                <div class="mb-2 col-lg-6 px-0 col-md-6 col-sm-6">
                                    <label class="form-control-label">Gender</label>
                                    <input type="text" disabled v-model="patientData.gender" placeholder="Gender"
                                        class="form-control " />
                                </div>
                                ...
                                <div class="mb-2 col-lg-6 pl-0 pr-2 col-md-6 col-sm-6">
                                    ...
                                    <validation-provider rules="required" v-slot="{ errors }">
                                        <VSelect label="name" v-model="encounterData.clinic" class="text-14"
                                            :options="clinics">
                                        </VSelect>
                                ...
                                <div class="mb-2 col-lg-6 px-0 col-md-6 col-sm-6">
                                    ...
                                    <validation-provider rules="required" v-slot="{ errors }">
                                        <VSelect class="text-14" label="name" v-model="encounterData.encounter_type"
                                            :options="['Walk in']">
                                        </VSelect>
                                        <span class="text-12" style="color: red">{{
                                        errors[0]
                        ...
                        <div class="my-3 d-flex justify-content-center">
                            ...
                            <BaseButton watchRequest @click.prevent="startEncounter" class="btn-primary">Create
                                Encounter
                            </BaseButton>
                        </div>
        ...
        <div class="col-12 mb-3">
            <div class="d-flex justify-content-between">
                ...
                <div>
                    <BaseButton @click="newEncounter" class="btn-outline-primary">New Encounter</BaseButton>
                </div>
            </div>
        </div>
        <div class="row">
                        ...
                        <template #action="{ data: { item } }">
                            <b-dropdown variant="link" toggle-class="text-decoration-none text-center" no-caret>
                                ...
                                <template class="p-0 mx-auto text-center" #button-content>
                                    <div>
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" style="color: #000" class="bi bi-three-dots-vertical"
                                            viewBox="0 0 16 16">
                                            <path
                                ...
                                <template v-if="dropdownItem.length > 0">
                                    <b-dropdown-item v-for="(dropdown, index) in dropdownItem" right :key="index"
                                        class="text-capitalize text-14" @click="optionClicked(item, index)">{{
