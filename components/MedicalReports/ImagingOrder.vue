            ...
            <b-sidebar id="sidebar-backdrop3" title="Sidebar with backdrop" :backdrop-variant="'dark'" backdrop shadow
              ...
              <div class="p-4">
                ...
                <div class="col-md-12">
                  ...
                  <VSelect v-model="filter.service_center" style="font-size: 13px" label="name" class=""
                ...
                <div class="col-md-12">
                  ...
                  <VSelect v-model="filter.modality" style="font-size: 13px" label="name" class=""
...
export default {
  ...
  methods: {
    async pageChange(
      ...
      try {
        this.busy = true
        if (this.dataObj.img_order) {
          const data = await this.$api.medicalReport.getImgingOrder(
            this.dataObj.img_order,
            {
              ...newFilterObject,
            }
          )
