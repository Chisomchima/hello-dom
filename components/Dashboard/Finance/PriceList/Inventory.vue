  ...
  export default {
    ...
    methods: {
      ...
      async getPriceListItems(
        page = 1,
        e = { size: 10, name: '', module: 'Inventory', price_list: this.$route.params.id, }
      ) {
        this.filter = e
      ...
      async save_file() {
        ...
        const response = await fetch(
          `${process.env.BASE_URL}finance/price_lists/${this.$route.params.id}/price_list_items/spreadsheet_download/?module=Inventory`,
          {
            headers: {
