  ...
  <div class="upload-doc-wrapper w-max-100 justify-content-between mb-3">
    ...
    >
      ...
      <div class="text-center">
        <img
          v-if="
            ['.png', '.jpeg', '.jpg', '.gif', 'png', 'jpeg', 'jpg', 'gif'].includes(
              fileToViewType
            )
          "
        ...
        <!-- <audio v-if="['.mp3', 'mp3'].includes(fileToViewType)" controls>
          <source :src="fileToViewComputed.essay_sample_url" type="audio/mpeg" />
  ...
  methods: {
    ...
    async downloadFile(file) {
      ...
      try {
        ...
        const filetype = this.wholeFile.format.split(".").pop();
