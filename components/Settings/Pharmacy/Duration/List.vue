<template>
  <div>
    ...
    <SettingsPharmacyDurationAddDuration
      :edit-data="editObj"
...
export default {
  ...
  methods: {
    ...
    async pageChange(page = 1, e = { name: '', size: 10 }) {
      try {
        this.busy = true
        const data = await this.$api.pharmacy.getDurations({ page, ...e })
