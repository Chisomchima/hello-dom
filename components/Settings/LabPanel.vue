<template>
    <div>
        <div>
            <b-modal id="Add-panel" title="Add Laboratory Panel" centered hide-footer ref="addLabModal"
                @hide="closeModal">
                <div>
...
">
                                ...
                                <div class="mb-2 col-lg-10 px-0 col-md-10 col-sm-10">
                                    ...
                                    <div class="d-flex align-items-end">
                                        <div class="w-100">
                                            ...
                                            <validation-provider class="w-100" rules="required" v-slot="{ errors }">
                                                <VSelect class=" text-grey text-14" placeholder="Type to search"
                                                    label="name" v-model="panel.obv"
                                                    :options="observationWithoutPagination" :loading="cue"
                                ...
                                <div class="mb-2 col-lg-10 px-0 col-md-10 col-sm-10">
                                    ...
                                    <validation-provider rules="required" v-slot="{ errors }">
                                        <VSelect class=" text-grey text-14" placeholder="Type to search" label="name"
                                            :reduce="(option) => option" :options="specimensForModal" :loading="cue1"
                                            v-model="typeId">
                                        </VSelect>
                                        <span class="text-12" style="color: red">{{
                                        errors[0]
                            ...
                            <div class="my-3 d-flex justify-content-center">
                                ...
                                <BaseButton @click.prevent="addPanel" class="">Save
                                </BaseButton>
                            </div>
        ...
        <!-- ************edit************ -->
        <div>
            <b-modal id="Edit-panel" title="Edit Laboratory Panel" centered hide-footer ref="editLabModal"
                @hide="closeEditModal">
                <div>
                    <ValidationObserver v-slot="{ validate }">
                        <form>
...
">
                                    ...
                                    <div class="d-flex align-items-end">
                                        <div class="w-100">
                                            <div style="position: relative" class="mb-2 d-flex w-100">
                                                <div class="w-100">
                                                    <validation-provider rules="required" v-slot="{ errors }">
                                                        <v-select class=" text-grey text-14"
                                                            placeholder="Type to search" label="name"
                                ...
                                <div class="mb-2 col-lg-10 px-0 col-md-10 col-sm-10">
                                    ...
                                    <validation-provider rules="required" v-slot="{ errors }">
                                        <v-select class=" text-grey text-14" placeholder="Type to search" label="name"
                            ...
                            <div class="my-2 px-5 align-item-start">
                                ...
                                <input v-model="editPanel.active" type="checkbox" placeholder="Name"
                            ...
                            <div class="my-3 d-flex justify-content-center">
                                ...
                                <BaseButton @click.prevent="editPanelFunc" class="">Save
                                </BaseButton>
                            </div>
        ...
        <div>
            <UtilsFilterComponent disable-pagination :disable-visualization="true" search-placeholder="Search">
                <template #besideFilterButton>
                    <BaseButton class="btn-outline-primary" @click="openLabPanelModal">Add Lab panel
                    </BaseButton>
                </template>
                <table-component :paginate="true" :perPage="perPage" :fields="fields" :busy="busy" :pages="pages"
                    :items="labPanels" @page-changed="getLabPanels($event)">
                    <template #obv="{ data }">
                    ...
                    <template #specimen_type="{ data }">
                        <div style="max-width: 5rem" class="first text-12 pointer badge text-truncate"
